import {findCalibrationValue, sumCalibrationValues, sumCalibrationValuesFromFile} from '../../src/day1/part1';

describe('Tests for part 1 of day1', () => {
...
describe('sumCalibrationValuesFromFile Tests', ()=>{
    it('should return the sum based off the file', async () => {
        const filepath = '/Users/cwillingham/Development/Personal/adventOfCode2023/src/day1/inputs/part1.txt';
        const result = await sumCalibrationValuesFromFile(filepath);
        expect(result).toEqual(12 + 38 + 15 + 77);
    });
})
